        ...
        <div className="p-4 sm:p-6 lg:p-8">
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">Chi tiết tài chính theo từng campaign</p>
            </div>
            <button
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredCampaigns.map((item) => {
                ...
                return (
                  <div key={item.campaign.id} className="bg-white p-4 sm:p-6 rounded-lg border border-gray-200 shadow-sm">
                    <div className="flex flex-col sm:flex-row items-start sm:items-start justify-between mb-4 gap-3">
                      <div className="flex-1 w-full">
                        <div className="flex items-center gap-2 sm:gap-3 mb-2">
                          <h3 className="text-base sm:text-lg font-semibold text-gray-900">{item.campaign.title}</h3>
                          <Link 
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                      <div className="p-3 sm:p-4 bg-blue-50 rounded-lg">
                        ...
                        <div className="text-xs text-gray-500 hidden sm:block mt-1">{item.campaign.goal_amount.toLocaleString('vi-VN')} VND</div>
                      </div>
