...
/**
 * K6 Load Testing Script cho MACha Server - Production
 * 
 * Mục tiêu:
 ...
 * 
 * ⚠️ CẢNH BÁO: Script này test trên PRODUCTION server
 * - Chỉ chạy trong giờ off-peak
 ...
 * 3. Chạy: k6 run monitoring/k6/production.js
 * 
 * Hoặc sử dụng script helper:
 * ./monitoring/k6/run-production.sh
 */
...
export const options = {
    stages: [
        ...
        //  - Ghi lại: RPS tổng, latency p95/p99, error rate
...
const BASE_URL = __ENV.BASE_URL || 'https://macha-production-4144.up.railway.app';
